...
def new_file(path1=None, path2=None, path3=None):
    if path1 or path2 or path3 is None:
        path1 = '1.txt'
        path2 = '2.txt'
        path3 = '3.txt'
        os.chdir('sorted')
        outout_file = "new_file.txt"
...
if __name__ == '__main__':
    ...
    print(cook_book)
    print('Task 2')
    pprint(get_shop_list_by_dishes(dishes=['Запеченный картофель', 'Утка по-пекински'], person_count=3))
